      ...
      <div className="grid md:grid-cols-3 ">
        ...
        <section className=" col-span-2 bg-white dark:bg-gray-900">
          <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 className="mb-4 text-[38px] tracking-tight font-bold text-center text-gray-900 dark:text-white">
              Contact <span className="text-[#2CC5B2]">Us</span>
            </h2>
            <p className="mb-3 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-lg">
              Got a technical issue? Want to send feedback about a beta feature?
              Need details about our Business plan? Let us know.
            </p>
            <form
            action="#"
              // action="https://docs.google.com/forms/d/e/1FAIpQLSdLtYd3LLH5X5zlx9V-qgaKcujKwttvn4aw3wgIkTj8su8DWA/formResponse?"
              // method="POST"
              className="space-y-3"
            >
              <div>
